use crate::{algorithms::sweep::SweepFunction, iterators::grid_iterator::{HashMapGridIterator, GridIteratorT}, storage::linear_grid::SparseGridData};
...
{
    fn recurse(values: &mut [[f64; DIM_OUT]], iterator: &mut HashMapGridIterator<D>, dimension: usize, left_value: [f64; DIM_OUT], right_value: [f64; DIM_OUT])
    {
...
{
    #[inline]
    fn execute_in_place(&mut self, values: &mut [[f64; DIM_OUT]], iterator: &mut crate::iterators::grid_iterator::HashMapGridIterator<D>, _storage: &SparseGridData<D>, dimension: usize) {
        // left boundary
