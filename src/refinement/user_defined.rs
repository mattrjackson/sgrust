...
/// 
pub type UserRefinementFunction<const D: usize, const DIM_OUT: usize> = dyn Fn(&crate::storage::linear_grid::SparseGridData<D>,  &[[f64; DIM_OUT]], &[[f64; DIM_OUT]], usize) -> f64 + Send + Sync;
...
{
    fn eval(&self, storage: &crate::storage::linear_grid::SparseGridData<D>, alpha: &[[f64; DIM_OUT]], values: &[[f64; DIM_OUT]], seq: usize) -> f64 {
