use crate::dynamic::{iterators::dynamic_grid_iterator::{DynamicHashMapGridIterator, GridIteratorT}, storage::SparseGridData};

pub trait SweepFunction<T, R>
{
    fn execute_in_place(&mut self, values: &mut [R], iterator: &mut DynamicHashMapGridIterator, storage: &SparseGridData, dimension: usize);
}
